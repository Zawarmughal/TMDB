...
import { UPCOMMING_MOVIES } from "../redux/constant"
...
export default function UpCommingMovies() {
    ...
    const selector = useSelector((state) => state.Movie.upCommingMovies)
    useEffect(() => {
        dispatch(
            {
    ...
    return (
        <Box>
            <Container maxWidth="xl" sx={{ mt: 6 }}>
                <Typography variant='h4' sx={{ fontWeight: "bold" }}>UpComming</Typography>
                <Grid item lg={12} container>
                    ...
                    <Grid item lg={9} md={12} sm={12} xs={12} container align='center'>
                        ...
                        <LoadMore type={UPCOMMING_MOVIES} />
                    </Grid>
                </Grid>
            </Container>
        </Box>
